...
const CACHE=PREFIX+'v29-android-settings-recovery';
const FILES=['./','./index.html','./styles.css','./config.js','./app.js','./entry-session.js','./settings-menu.js','./manifest.webmanifest'];
